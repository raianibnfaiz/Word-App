...
//            val queryUrl: Uri = Uri.parse("${WordListFragement.SEARCH_PREFIX}${item}translate+english+to+bangla")
//            val intent = Intent(Intent.ACTION_VIEW, queryUrl)
//            context.startActivity(intent)
            val action =WordListFragementDirections.actionWordListFragementToDetailFragment(detail = holder.button.text.toString())
